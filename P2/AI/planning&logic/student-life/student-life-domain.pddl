...
(:action have-lunch 
	...
	:parameters ( ?x ?y )
	:precondition (and (PERSON ?x) (or (IS-STUDENT ?x) (IS-TEACHER ?x)) (BUILDING ?y) (not (had-lunch ?x)) (HAS-RESTURANT ?y) (is-person-at ?x ?y))
	:effect (had-lunch ?x)
...
(:action attend-morning-lecture
	; WRITE HERE THE CODE FOR THIS ACTION
	:parameters (?x ?y ?z ?w)
	:precondition (and (PERSON ?x) (PERSON ?y) (BUILDING ?z) (LECTURE ?w) (IS-STUDENT ?x) (IS-TEACHER ?y) (IS-MORNING ?w) (IS-LECTURE-AT ?w ?z) (teaches-lecture ?y ?w)
                       (is-person-at ?x ?z) (not (had-lunch ?x)))
...
(:action attend-afternoon-lecture
	; WRITE HERE THE CODE FOR THIS ACTION
	:parameters (?x ?y ?z ?w)
	:precondition (and (PERSON ?x) (PERSON ?y) (BUILDING ?z) (LECTURE ?w) (IS-STUDENT ?x) (IS-TEACHER ?y) (IS-AFTERNOON ?w) (IS-LECTURE-AT ?w ?z) (teaches-lecture ?y ?w)
                       (is-person-at ?x ?z) (had-lunch ?x))
    :effect (attended-lecture ?x ?w)
)
