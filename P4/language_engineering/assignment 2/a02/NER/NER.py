...
#modif add of """" in the list of last_token
    def first_token_in_sentence(self):
           return self.last_token not in [None,'.', '!', '?','""""']
    
    def capitalized_last_token(self):
    ...
    def __init__(self, training_file, test_file, model_file, stochastic_gradient_descent,
        ...
        self.features = [
            ...
            #NER.FeatureFunction(self.capitalized_last_token)
        ]
        ...
        # reintialize the current and last token
        self.current_token = None #  The token currently under consideration.
        self.last_token = None #  The token on the preceding line.
        ...
        if test_set:
            ...
            # print the index of the misclassified datapoints
            false = b.index_false[0:10]
            for i in range(len(false)):
                print(test_set.x[false[i]], test_set.y[false[i]],false[i])
            for i in range(1,10):
                print(test_set.x[i], test_set.y[i])
