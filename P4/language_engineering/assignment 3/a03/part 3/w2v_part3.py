        ...
        for ep in range(self.__epochs):
            for i in tqdm(range(N)):
                ...
                for j in range(len(t[i])):
                    ...
                    self.__W[x[i]] -= self.__U[t[i][j]]*coef_1
                    ...
                    self.__W[x[i]] -= np.dot(self.__U[neg_samples_j].T, coef_2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--save', default='en.vectors', help='Filename where word vectors are saved')
